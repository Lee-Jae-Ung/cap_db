...
public class DrawVIBFeature extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        chart6.setBackground(getResources().getDrawable(R.drawable.parent_shadow));
...
// don't forget to refresh the drawing
    ...
    public void getPeriodFeature(String facility,String period){
        ArrayList<ArrayList<String>> resultText1;
        ...
        try {
            ...
            resultText1 = new Task().execute("http://" + ip + ":50010/manage/Device/SDG" + facility + ".csv/" + period).get();
            //resultText1 = new Task().execute("http://cb0a-203-250-77-240.ngrok.io/manage/Device/SDG" + facility + ".csv/" + period).get();
