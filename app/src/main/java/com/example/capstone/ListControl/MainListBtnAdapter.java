package com.example.capstone.ListControl;
...
import com.example.capstone.Activitiy.MainActivity;
...
public class MainListBtnAdapter extends BaseExpandableListAdapter {
    public ArrayList<ParentItem> parentItems; //부모 리스트를 담을 배열
    public ArrayList<ArrayList<ChildItem>> childItems; //자식 리스트를 담을 배열
